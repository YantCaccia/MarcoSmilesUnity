...
public class HandDataRecorder : MonoBehaviour
{
    ...
    private void saveData(int note,DataToStore left, DataToStore right)
    {
        ...
        {
            //  Se il file � presente nel path, crea una stringa contenente tutte le features e id della nota, per salvare sul file nel path
    ...
    */
    ...
    /// <summary>
    /// Genera il path per il file da utilizzare. il path � formato da: path (La cartella in appdata dell'aplicazione); 
    ...
    /// il path � formato da: path (La cartella in appdata dell'aplicazione); folderName (Cartella dei datasets);
    ...
    /// <summary>
    /// Prende il path per il datasaet. Versione public di generatepath. [(� davvero necessaria???? o basta mettere generate path a public?)]
    /// </summary>
    ...
    void SaveOnFile(string texttosave,string filename)
    {
        ...
        {
            // Se il file esiste gi�, aggiungi il testo al file
